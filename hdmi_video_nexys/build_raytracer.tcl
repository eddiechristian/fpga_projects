# HDMI Ray Tracer Build Script for Nexys Video
# Integrates ray tracer with Digilent rgb2dvi IP
...
# Create Clocking Wizard IP for pixel and ray tracer clocks
# 640x480@60Hz requires 25.175 MHz pixel clock
...
connect_bd_net [get_bd_pins clk_wiz_0/clk_out3] [get_bd_pins rgb2dvi_0/SerialClk]
connect_bd_net [get_bd_pins clk_wiz_0/clk_out1] [get_bd_ports pixel_clk]
connect_bd_net [get_bd_pins clk_wiz_0/clk_out2] [get_bd_ports clk_50]
