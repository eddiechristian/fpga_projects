...
# Run Vivado with logs redirected to logs directory (stay in project root)
vivado -mode batch -source build.tcl -log logs/build_${TIMESTAMP}.log -journal logs/build_${TIMESTAMP}.jou
