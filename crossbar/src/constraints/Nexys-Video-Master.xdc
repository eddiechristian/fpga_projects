...
## LEDs
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS25 } [get_ports { test_done }]; #IO_L15P_T2_DQS_13 Sch=led[0]
...
## Crossbar Design I/O - Using Pmod JA for data I/O
# Input vectors (simplified - only using a few bits for testing)
set_property -dict { PACKAGE_PIN AB22  IOSTANDARD LVCMOS33 } [get_ports { a_x[0] }]; #IO_L10N_T1_D15_14 Sch=ja[1]
set_property -dict { PACKAGE_PIN AB21  IOSTANDARD LVCMOS33 } [get_ports { a_x[1] }]; #IO_L10P_T1_D14_14 Sch=ja[2]
set_property -dict { PACKAGE_PIN AB20  IOSTANDARD LVCMOS33 } [get_ports { a_y[0] }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=ja[3]
set_property -dict { PACKAGE_PIN AB18  IOSTANDARD LVCMOS33 } [get_ports { a_y[1] }]; #IO_L17N_T2_A13_D29_14 Sch=ja[4]
set_property -dict { PACKAGE_PIN Y21   IOSTANDARD LVCMOS33 } [get_ports { a_z[0] }]; #IO_L9P_T1_DQS_14 Sch=ja[7]
set_property -dict { PACKAGE_PIN AA21  IOSTANDARD LVCMOS33 } [get_ports { a_z[1] }]; #IO_L8N_T1_D12_14 Sch=ja[8]
set_property -dict { PACKAGE_PIN AA20  IOSTANDARD LVCMOS33 } [get_ports { b_x[0] }]; #IO_L8P_T1_D11_14 Sch=ja[9]
set_property -dict { PACKAGE_PIN AA18  IOSTANDARD LVCMOS33 } [get_ports { b_x[1] }]; #IO_L17P_T2_A14_D30_14 Sch=ja[10]

# Result output (using Pmod JB for additional I/O)
set_property -dict { PACKAGE_PIN V9    IOSTANDARD LVCMOS33 } [get_ports { result[0] }]; #IO_L21P_T3_DQS_34 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { result[1] }]; #IO_L21N_T3_DQS_34 Sch=jb_n[1]
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33 } [get_ports { result[2] }]; #IO_L19P_T3_34 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { result[3] }]; #IO_L19N_T3_VREF_34 Sch=jb_n[2]
set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports { result[4] }]; #IO_L24P_T3_34 Sch=jb_p[3]
set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { result[5] }]; #IO_L24N_T3_34 Sch=jb_n[3]
set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { result[6] }]; #IO_L23P_T3_34 Sch=jb_p[4]
set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33 } [get_ports { result[7] }]; #IO_L23N_T3_34 Sch=jb_n[4]

# Tie remaining unused ports to constants to satisfy constraints
set_property BITSTREAM.GENERAL.COMPRESS TRUE [current_design]
set_property BITSTREAM.CONFIG.CONFIGRATE 50 [current_design]
set_property CONFIG_MODE SPIx4 [current_design]

# Set all remaining unconstrained ports as internal (no physical I/O)
set_property -dict {IOSTANDARD LVCMOS33 PACKAGE_PIN Y6} [get_ports {b_y[0]}]
set_property -dict {IOSTANDARD LVCMOS33 PACKAGE_PIN AA6} [get_ports {b_y[1]}]
set_property -dict {IOSTANDARD LVCMOS33 PACKAGE_PIN AA8} [get_ports {b_z[0]}]
set_property -dict {IOSTANDARD LVCMOS33 PACKAGE_PIN AB8} [get_ports {b_z[1]}]

# For remaining 28 bits of each vector, set them as dummy I/O to satisfy DRC
# (In a real design, you'd either use them or remove them from the top-level)
set_property DONT_TOUCH true [get_ports {a_x[*]}]
set_property DONT_TOUCH true [get_ports {a_y[*]}]
set_property DONT_TOUCH true [get_ports {a_z[*]}]
set_property DONT_TOUCH true [get_ports {b_x[*]}]
set_property DONT_TOUCH true [get_ports {b_y[*]}]
set_property DONT_TOUCH true [get_ports {b_z[*]}]
set_property DONT_TOUCH true [get_ports {result[*]}]
