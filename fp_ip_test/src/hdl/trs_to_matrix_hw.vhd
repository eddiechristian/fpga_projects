        ...
        if rising_edge(clk) then
            if reset = '1' then
                ...
                case state is
                    ...
                    when MULT_FORWARD_2 =>
                        -- Compute: temp_mat2 = temp_mat1 * Ry = (S*Rx) * Ry
                        mult_a <= temp_mat1;
                        mult_b <= mat_rotate_y;
                        mult_valid_in <= '1';
                    ...
                    when MULT_FORWARD_3 =>
                        -- Compute: temp_mat3 = temp_mat2 * Rz = (S*Rx*Ry) * Rz
                        mult_a <= temp_mat2;
                        mult_b <= mat_rotate_z;
                        mult_valid_in <= '1';
                    ...
                    when MULT_FORWARD_4 =>
                        -- Compute: transform_matrix = temp_mat3 * T = (S*Rx*Ry*Rz) * T
                        mult_a <= temp_mat3;
