# Vivado Project Creation Script for LED Test
# This script creates the complete project with all source files
...
puts "========================================"
puts "Creating LED Test VHDL Project"
puts "========================================"
...
#=============================================================================
if {[llength [glob -nocomplain src/constraints/*.xdc]] > 0} {
    puts "Adding constraints..."
    add_files -fileset constrs_1 -norecurse [glob src/constraints/*.xdc]
